...
// task-container DOM elements
export const taskContainer = document.querySelector(".task-container")
export const taskHeading = taskContainer.querySelector("#task-heading")
export const task = taskContainer.querySelector("#task")
export const pulseElement = taskContainer.querySelector(".pulse")
